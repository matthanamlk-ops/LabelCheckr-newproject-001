...
export const OFFICIAL_FDA_RECORDS: Record<string, FDARecord> = {
  ...
  '12-3-04567-1-0001': {
    fdaNumber: '12-3-04567-1-0001',
    registeredFoodName: 'น้ำมะม่วงเข้มข้น กลิ่นกุหลาบ (ตรา เข้มข้นจัง)',
    manufacturerName: 'บริษัท เข้มข้นจัง จำกัด',
    manufacturerAddress: 'บ้านเลขที่ 1 ต.ตลาดขวัญ อ.เมือง จ.นนทบุรี 11000',
    foodCategory: 'น้ำผลไม้และเครื่องดื่มในภาชนะบรรจุที่ปิดสนิท',
    foodCategoryCode: 'สธ. 356',
    licenseStatus: 'คงอยู่',
    licenseExpiry: '31 ธันวาคม 2572',
    licenseNumber: 'ใบอนุญาตผลิตอาหาร (แบบ ส.2): 12-3-04567',
    mandatoryGDA: true,
    notes: 'น้ำผลไม้พร้อมดื่ม แสดงส่วนประกอบสำคัญเรียงลำดับชัดเจน ตรวจสอบถูกต้องตามเกณฑ์ อย.'
  }
};
